...
from iu_main import Ui_MainWindow
from new_transaction import Ui_Dialog
from connection import Data



class telegram-bot-assistant(QMainWindow):
    def __init__(self):
        ...
        self.ui.label_outcome_balance.setText(self.conn.total_outcome())
        self.ui.label_smartphone.setText(self.conn.total_smartphone())
        self.ui.label_televisions.setText(self.conn.total_televisions())
        self.ui.label_laptope.setText(self.conn.total_laptope())
        self.ui.label_other.setText(self.conn.total_other())
    ...
    def open_new_transaction_window(self):
        ...
        self.ui_window.setupUi(self.ui_window)
        self.ui_window.show()
        sender = self.sender()
        if sender.text() == "New transaction":
            self.ui_window.lbl_new_transaction.clicked.connect(self.add_new_transaction)
        else:
            self.ui_window.lbl_new_transaction.clicked.connect(self.edit_current_transaction)
